...
/** A struct containing all information necessary to schedule/cancel a
    ...
    - cb and cb_user_data represent a gRPC-provided callback and an argument
      ...
      asynchronously, and |cb| is expected to be called with the parameter
      |cb_user_data| at the end of each asynchronous reloading operation, to
      notify the C core stack to continue the handshake.
